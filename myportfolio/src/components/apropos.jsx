                ...
                <div className='col-start-1 md:col-start-3 col-span-12 md:col-span-8'>
                    ...
                    <div className='grid grid-cols-1 mr-4 md:mr-auto md:grid-cols-8 gap-8 mt-4'>
                        <div className='col-span-1 md:col-span-4 border border-colorRoseBackground p-3 rounded-lg custom-shadow '>
                            ...
                            <p className='text-colorMarron my-3 text-sm text-justify'>Malgré la variété des tâches que j’ai pu accomplir au fil des années, ce travail est peu à peu devenu routinier. J’aspire à un rôle qui me permette de <span className='font-bold'>réfléchir</span>, de <span className='font-bold'>résoudre des problèmes</span> et d’<span className='font-bold'>apprendre continuellement</span>. C’est cette part de nouveauté et de défi qui alimente mon épanouissement professionnel.</p>
                        </div>

                        <div className='col-span-1 md:col-span-4 border border-colorRoseBackground p-3 rounded-lg custom-shadow'>
                            <h2 className='text-colorMarron text-center text-lg italic'>Pourquoi le développement web ?</h2>
                            <p className='text-colorMarron my-3 text-sm text-justify'>Ce qui m’a attirée dans l’informatique, c’est l’envie de comprendre ce qui se cache derrière les ERP. J’ai commencé à apprendre en <span className='font-bold'>autodidacte</span>, passant des heures à coder, jusqu’à ce que mon conjoint me rappelle qu’il était temps d’aller se coucher 😂.</p>
                            <p className='text-colorMarron my-3 text-sm text-justify'>Mon expérience chez Ada a confirmé mon coup de cœur pour ce domaine. Que ce soit le back-end ou le front-end, je trouve cet <span className='font-bold'>univers passionnant</span>, sans place pour la routine. J’ai cependant une <span className='font-bold'>préférence pour le front</span>, qui stimule ma <span className='font-bold'>créativité</span>. Aujourd’hui, j’ai enfin le sentiment d’avoir trouvé ma voie.
                            </p>
                        </div>

                        <div className='col-span-1 md:col-span-4 border border-colorRoseBackground p-3 rounded-lg custom-shadow'>
                            <h2 className='text-colorMarron text-center text-lg italic'>Que puis-je apporter à une équipe ?</h2>
                            <p className='text-colorMarron my-3 text-sm text-justify'>Je suis <span className='font-bold'>toujours de bonne humeur</span> et possède un excellent sens de l’organisation, ce qui me permet de m’<span className='font-bold'>adapter facilement</span> à tout environnement de travail. </p>
                            <p className='text-colorMarron my-3 text-sm text-justify'>Fortement expérimentée dans le domaine des ERP, j’ai acquis une <span className='font-bold'>compréhension approfondie des besoins des utilisateurs</span>, ce qui me permet d’apporter des compétences complémentaires en gestion et en développement.</p>
                            <p className='text-colorMarron my-3 text-sm text-justify'><span className='font-bold'>Dynamique</span>, <span className='font-bold'>curieuse</span> et <span className='font-bold'>motivée</span>, je suis prête à contribuer activement à la réussite collective et à continuer d’apprendre au sein de l’équipe.</p>
                        </div>

                        <div className='col-span-1 md:col-span-4 border border-colorRoseBackground p-3 rounded-lg custom-shadow'>
                            <h2 className='text-colorMarron text-center text-lg italic'>Quels sont mes loisirs en dehors du code?</h2>
                            <p className='text-colorMarron my-3 text-sm text-justify'>
                            ...
                            <p className='text-colorMarron my-3 text-sm text-justify'>En dehors du sport, j’apprécie les <span className='font-bold'>jeux de société</span>, des jeux de plateau aux jeux d’ambiance, pour partager des moments conviviaux. Enfin, je m’adonne à des loisirs créatifs, notamment les <span className='font-bold'>montages photo et vidéo</span>, qui stimulent mon imagination.</p>
                        </div>
                    </div>
                </div>
